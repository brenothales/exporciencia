...
//       strokeStyle: 'rgba(255, 255, 255, 0.3)'
  ...
  resizeEvent: function() {
    ...
    gradient.addColorStop(0,"rgb(13, 136, 167)");
    gradient.addColorStop(0.3,"rgba(244, 221, 19, 0.5)");
    gradient.addColorStop(0.5,"rgba(255, 255, 255, 0.2)");
    gradient.addColorStop(0.7,"rgb(1, 189, 87)");
    gradient.addColorStop(1,"rgb(246, 53, 30)");
